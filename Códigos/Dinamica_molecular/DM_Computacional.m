...
%     end
% end
%% Codico con simulacion estática en 3D ayuda CHEPITO NO REBOTAN EN LAS PAREDES
...
% paso_tiempo = 0.5;        % Tamaño del paso de tiempo en segundos
% masa_particula = 1.0;     % Masa de cada partícula
...
%                 velocidades(i, dim) = -velocidades(i, dim);
%                 %posiciones(i, dim) = max(0, min(espacio, posiciones(i, dim)));
%             end
%         end
%     end
%     
...
% paso_tiempo = 0.01;      % Tamaño del paso de tiempo en segundos
% masa_particula = 1.0;    % Masa de cada partícula
% espacio = 3.5;          % Tamaño del espacio a utilizar
% x_path = [];
% y_path = [];
% 
% % % Distribuir las partículas equidistantemente en el espacio
...
% % Parámetros de la simulación
% num_particulas = 2;
% tiempo_simulacion = 2 ;   % Tiempo de simulación en segundos
% paso_tiempo = 0.01;      % Tamaño del paso de tiempo en segundos
% masa_particula = 1.0;    % Masa de cada partícula
